...
public class Stage3Test {
	...
	public void testSame() {
		...
		assertFalse(Stage3.same(arr1, arr2));
	...
	public void testGetLeastFrequentItem() {
		...
		assertEquals(1, Stage3.getLeastFrequentItem(new int[]{1, 2, 3, 4, 5, 6, 7}));
		assertEquals(7, Stage3.getLeastFrequentItem(new int[]{8, 8, 8, 8, 6, 6, 6, 7, 7}));
		assertEquals(7, Stage3.getLeastFrequentItem(new int[]{7, 7, 7, 5, 5, 5}));
		assertEquals(5, Stage3.getLeastFrequentItem(new int[]{5, 7, 5, 7, 1, 1, 1, 1, 5, 7}));
	}
