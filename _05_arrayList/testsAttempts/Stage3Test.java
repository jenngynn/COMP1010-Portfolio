...
public class Stage3Test {	
	...
	void testSecondIndexOf() {
		assertEquals(-1, Stage3.secondIndexOf(null, 65));
		assertEquals(-1, Stage3.secondIndexOf(emptyList, 96));
		assertEquals(-1, Stage3.secondIndexOf(singleItemList, -7));
		assertEquals(-1, Stage3.secondIndexOf(singleItemList, 1));
		assertEquals(-1, Stage3.secondIndexOf(multiplesTen1, 10));
		assertEquals(-1, Stage3.secondIndexOf(multiplesTen1, 70));
		assertEquals(-1, Stage3.secondIndexOf(multiplesTen1, 20));
		assertEquals(-1, Stage3.secondIndexOf(multiplesTen1, 90));
		assertEquals(1, Stage3.secondIndexOf(allZeroes1, 0));
		ArrayList<Integer> temp = new ArrayList<Integer>(Arrays.asList(10,70,20,90,70,30,10,10,10,70));
		assertEquals(4, Stage3.secondIndexOf(temp, 70));
		assertEquals(6, Stage3.secondIndexOf(temp, 10));
	}
