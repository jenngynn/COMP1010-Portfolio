...
public class Stage4Test {
	...
	public void testGetAllItemsFrom() {
		assertEquals("[4, 4, 4, 5, 5, 1, 1]", Stage4.getAllItemsFrom(new ArrayList<Integer>(Arrays.asList(7,4,1,1,3,4,5,5,6,3,7,4)), new ArrayList<Integer>(Arrays.asList(4,5,1))).toString());
		assertEquals("[]", Stage4.getAllItemsFrom(new ArrayList<Integer>(Arrays.asList(7,4,1,1,3,4,5,5,6,3,7,4)), new ArrayList<Integer>(Arrays.asList(2, 8, 9))).toString());
		assertEquals("[50, 50, 50]", Stage4.getAllItemsFrom(new ArrayList<Integer>(Arrays.asList(10,100000,50,1000000,50,50000000,50)), new ArrayList<Integer>(Arrays.asList(50))).toString());
		assertEquals("[10, 20, 30, 50, -70000000, -70000000]", Stage4.getAllItemsFrom(new ArrayList<Integer>(Arrays.asList(50,-70000000,10,20,30,-70000000)), new ArrayList<Integer>(Arrays.asList(10,20,30,40,50,-70000000))).toString());
	}
}
